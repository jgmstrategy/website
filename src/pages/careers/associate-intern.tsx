...
export default function AssociateInternJobPosting() {
  return (
    <>
      <Head>
        <title>Associate Intern Job Posting</title>
      ...
      <Container maxWidth='md' sx={{ paddingTop: '4rem', paddingBottom: '4rem' }}>
        ...
        <h1 style={{ textAlign: 'center', paddingBottom: '1rem' }}>Associate Intern</h1>
        ...
        <p>
          Business majors wanting to see what your classes look like in the real world? We will
          provide real casework for you to get your hands dirty with, and it will be fun at the
          same time!
        </p>
        <p>
