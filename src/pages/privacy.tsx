  ...
  return (
    <>
      ...
      <Container sx={{ paddingTop: '2rem', paddingBottom: '3rem' }}>
        ...
        <p>
          This privacy notice for JGM Strategy Consulting (&quot;Company,&quot; &quot;we,&quot;
          ...
          (&quot;Services&quot;), such as when you: Questions or concerns? Reading this privacy
        ...
        <p>
          ...
          may process personal information depending on how you interact with JGM Strategy
          Consulting and the Services, the choices you make, and the products and features you use.
        </p>
        <p>
        ...
        <p>
          ...
          your consent. We process your information only when we have a valid legal reason to
          do so.
        </p>
        <p>
        ...
        <div>
          <Accordion>
            ...
            >
              <Typography sx={{ fontWeight: 600 }}>1. What information do we collect?</Typography>
            </AccordionSummary>
            <AccordionDetails>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              ...
              <ul>
                <li>to provide and render Services to you</li>
              </ul>
            </AccordionDetails>
          </Accordion>
          <Accordion>
            ...
            <AccordionDetails>
              ...
              <Typography sx={{ paddingBottom: '1rem' }}>
                ...
                acquisition of all or a portion of our business to another company. Affiliates. We
                may share your information with our affiliates, in which case we will require those
                affiliates to honor this privacy notice. Affiliates include our parent company and
                any subsidiaries, joint venture partners, or other companies that we control or
                that are under common control with us. Business Partners. We may share your
          ...
          <Accordion>
            ...
            <AccordionDetails>
              ...
              <Typography sx={{ paddingBottom: '1rem' }}>
                Our servers are located in the United States. If you are accessing our Services
                from outside, please be aware that your information may be transferred to, stored,
                and processed by us in our facilities and by those third parties with whom we may
              ...
              <Typography sx={{ paddingBottom: '1rem' }}>
                ...
                measures to protect your personal information in accordance with this privacy
          ...
          <Accordion>
            ...
            <AccordionDetails>
              ...
              <Typography sx={{ paddingBottom: '1rem' }}>
                ...
                parent or guardian of such a minor and consent to such minor dependent&apos;s use
                of the Services. If we learn that personal information from users less than 18
          ...
          <Accordion>
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
            >
              <Typography sx={{ fontWeight: 600 }}>9. What are your privacy rights?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography sx={{ paddingBottom: '1rem' }}>
              ...
              <Typography sx={{ paddingBottom: '1rem' }}>
                ...
                or terminate your account, you can: Upon your request to terminate your account, we
          ...
          <Accordion>
            ...
            <AccordionDetails>
              ...
              <Typography sx={{ paddingBottom: '1rem' }}>
                ...
                notice, we may notify you either by prominently posting a notice of such changes or
                by directly sending you a notification. We encourage you to review this privacy
          ...
          <Accordion>
            ...
            >
              <Typography sx={{ fontWeight: 600 }}>
                13. How we you contact us about this notice?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography sx={{ paddingBottom: '1rem' }}>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography sx={{ paddingBottom: '1rem' }}>
                ...
                please fill out and submit a data subject access request by emailing us.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </div>
